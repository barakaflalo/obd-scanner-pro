  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("svg", {
      ...
      children: [/*#__PURE__*/_jsxDEV("path", {
        ...
        strokeWidth: "6",
        strokeLinecap: "round"
      }, void 0, false), warn && /*#__PURE__*/_jsxDEV("path", {
...
function SimpleChart({
  ...
  const vals = data.map(d => d[dataKey || 'v']);
  ...
  const pts = data.map((d, i) => {
    ...
    const y = height - (d[dataKey || 'v'] - mn) / (mx - mn || 1) * (height - 10) - 5;
    return x + ',' + y;
  }).join(' ');
  return /*#__PURE__*/_jsxDEV("div", {
    children: [/*#__PURE__*/_jsxDEV("svg", {
      ...
      children: [/*#__PURE__*/_jsxDEV("span", {
        children: mn.toFixed(0)
      }, void 0, false), /*#__PURE__*/_jsxDEV("span", {
        children: mx.toFixed(0)
      }, void 0, false)]
    }, void 0, true)]
  }, void 0, true);
}
function App() {
    ...
    return new Promise(async resolve => {
      ...
      try {
        ...
        if (cmRef.current === 'demo') {
          ...
          bleWrRef.current.writeValueWithoutResponse ? await bleWrRef.current.writeValueWithoutResponse(bytes) : await bleWrRef.current.writeValue(bytes);
        ...
        try {
          ...
          for (const ch of chs) {
            if (ch.properties.notify || ch.properties.indicate) {
              ...
              ch.addEventListener('characteristicvaluechanged', e => handleData(new TextDecoder().decode(e.target.value)));
            }
  ...
  const initELM = useCallback(async () => {
    setCI('Initializing...');
    for (const cmd of ['ATZ', 'ATE0', 'ATL0', 'ATH0', 'ATS0', 'ATSP0']) {
      const r = await send(cmd, cmd === 'ATZ' ? 5000 : 2000);
      addLog(cmd + ' → ' + r);
    }
    const ver = await send('ATI', 2000);
    addLog('Version: ' + ver);
    const volt = await send('ATRV', 2000);
    if (volt && !volt.includes('ERROR')) setVI(p => ({
      ...p,
      batt: volt.replace('V', '').trim()
    }));
    const proto = await send('ATDP', 2000);
    if (proto) setVI(p => ({
      ...p,
      proto
    }));
    const sup = await send('01 00', 3000);
    if (sup && sup.includes('41 00')) {
      const hx = sup.replace(/41\s*00\s*/, '').replace(/\s/g, '');
      const sp = [];
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("button", {
          ...
          children: Object.entries(LANGS).map(([k, v]) => /*#__PURE__*/_jsxDEV("option", {
            value: k,
            children: v
          }, k, false))
        }, void 0, false), isOn && /*#__PURE__*/_jsxDEV("button", {
          onClick: doPrint,
          style: {
            ...s.btnS('#1e293b'),
            border: '1px solid #334155',
          ...
          children: isOn ? t('on') : connStatus === 'ing' ? t('ing') : t('off')
        }, void 0, false)]
      }, void 0, true)]
    }, void 0, true), showAbout && /*#__PURE__*/_jsxDEV("div", {
      style: {
        ...s.card,
        margin: 0,
        borderRadius: 0,
    ...
    }, void 0, true), showReport && /*#__PURE__*/_jsxDEV("div", {
      style: {
        position: 'fixed',
        top: 0,
        left: 0,
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("span", {
          ...
          children: ["🖨️ ", isRTL ? 'דוח סריקה' : 'Scan Report']
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
            gap: 6
      ...
      style: s.tabR,
      children: [['connect', t('connect')], ['dash', t('dash')], ['dtc', t('dtc')], ['scan', t('scan')]].map(([id, lb]) => /*#__PURE__*/_jsxDEV("div", {
        style: s.tabB(tab === id),
        onClick: () => setTab(id),
        children: lb
      }, id, false))
      ...
      style: s.tabR,
      children: [['vehicle', t('vehicle')], ['term', t('term')], ['tools', t('tools')], ['guide', t('guide')]].map(([id, lb]) => /*#__PURE__*/_jsxDEV("div", {
        style: s.tabB(tab === id),
        onClick: () => setTab(id),
        children: lb
      }, id, false))
      ...
      children: [tab === 'connect' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            fontSize: 15,
            fontWeight: 600,
          ...
          children: [['ble', '📶', t('bleT'), t('bleD')], ['wifi', '📡', t('wifiT'), t('wifiD')], ['serial', '🔌', t('usbT'), t('usbD')], ['demo', '🎮', t('demoT'), t('demoD')]].map(([m, ic, ti, de]) => /*#__PURE__*/_jsxDEV("div", {
        ...
        }, void 0, false), connMethod === 'wifi' && !isOn && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: /*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
        ...
        }, void 0, false), connMethod === 'serial' && !isOn && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
        ...
        }, void 0, false), connMethod && !isOn && /*#__PURE__*/_jsxDEV("button", {
          style: {
          ...
          children: connStatus === 'ing' ? t('btnWait') : t('btnConn')
        }, void 0, false), connInfo && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: /*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 12,
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: t('log')
          }, void 0, false), logs.slice(-12).map((l, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 10,
              fontFamily: 'monospace',
      ...
      }, void 0, true), tab === 'dash' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
            gap: 6,
          ...
          children: [/*#__PURE__*/_jsxDEV("select", {
            ...
            children: Object.entries(PRESETS).map(([k, v]) => /*#__PURE__*/_jsxDEV("option", {
              value: k,
              children: v.n
            }, k, false))
          }, void 0, false), !monitoring ? /*#__PURE__*/_jsxDEV("button", {
            style: s.btnS('#22c55e'),
            onClick: startMon,
            disabled: !isOn,
            children: t('start')
            ...
            onClick: stopMon,
            children: t('stop')
          }, void 0, false), isOn && (!recording ? /*#__PURE__*/_jsxDEV("button", {
            style: s.btnS('#dc2626'),
            onClick: () => {
              setRec(true);
              setRecD([]);
            ...
            children: t('stopRec')
          }, void 0, false)), recData.length > 0 && /*#__PURE__*/_jsxDEV("button", {
            style: s.btnS('#3b82f6'),
            onClick: exportCSV,
          ...
          children: [/*#__PURE__*/_jsxDEV(Gauge, {
            ...
            warn: 6500,
            size: 125
          }, void 0, false), /*#__PURE__*/_jsxDEV(Gauge, {
            value: liveData['0D'] || 0,
            max: 260,
            label: PIDS['0D'].h,
            unit: "km/h",
        ...
        }, void 0, true), (fuelLH || liveData['42']) && /*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
            gap: 6,
            marginBottom: 8
          },
          children: [fuelLH && /*#__PURE__*/_jsxDEV("div", {
            style: {
              background: '#0f172a',
              borderRadius: 8,
              padding: '6px 10px',
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: [fuelLH, " L/h ", fuelL100 && /*#__PURE__*/_jsxDEV("span", {
                style: {
                  color: '#94a3b8',
                  fontSize: 11
                },
                children: ["(", fuelL100, " L/100km)"]
              }, void 0, true)]
            }, void 0, true)]
          }, void 0, true), liveData['42'] && /*#__PURE__*/_jsxDEV("div", {
            style: {
              background: '#0f172a',
              borderRadius: 8,
              padding: '6px 10px',
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: [parseFloat(liveData['42']).toFixed(1), " V"]
            }, void 0, true)]
          }, void 0, true)]
        }, void 0, true), recording && /*#__PURE__*/_jsxDEV("div", {
          style: {
            fontSize: 10,
            color: '#ef4444',
            textAlign: 'center',
          ...
          children: ["⏺ ", isRTL ? 'מקליט' : 'Recording', ": ", recData.length, " ", isRTL ? 'דגימות' : 'samples']
        }, void 0, true), alerts.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          style: {
            marginBottom: 8
          },
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: "🏁 0-100 km/h"
            }, void 0, false), !perfActive ? /*#__PURE__*/_jsxDEV("button", {
              style: {
                ...s.btnS('#22c55e'),
                marginTop: 4,
                width: '100%'
              ...
              disabled: !monitoring,
              children: isRTL ? 'התחל מדידה' : 'Start timer'
            }, void 0, false) : /*#__PURE__*/_jsxDEV("div", {
              style: {
                fontSize: 16,
                fontWeight: 700,
              ...
              children: perfStart ? ((Date.now() - perfStart) / 1000).toFixed(1) + 's' : isRTL ? 'דרוך...' : 'Ready...'
            }, void 0, false), perfTime && /*#__PURE__*/_jsxDEV("div", {
              style: {
                fontSize: 18,
                fontWeight: 700,
                color: '#22c55e',
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: ["🗺️ ", isRTL ? 'מחשבון נסיעה' : 'Trip computer']
            }, void 0, true), !tripStart ? /*#__PURE__*/_jsxDEV("button", {
              style: {
                ...s.btnS('#3b82f6'),
                marginTop: 4,
                width: '100%'
              ...
              disabled: !monitoring,
              children: isRTL ? 'התחל נסיעה' : 'Start trip'
            }, void 0, false) : /*#__PURE__*/_jsxDEV("div", {
              children: [/*#__PURE__*/_jsxDEV("div", {
                style: {
                  fontSize: 14,
                ...
                children: [tripDist.toFixed(1), " km"]
              }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
                style: {
                  fontSize: 10,
                  color: '#64748b'
                },
                children: [((Date.now() - (tripStart || Date.now())) / 60000).toFixed(0), " min | avg ", tripDist > 0 ? (tripDist / ((Date.now() - tripStart) / 3600000)).toFixed(0) : '0', " km/h"]
          ...
          children: PRESETS[preset].p.map(pid => {
            const p = PIDS[pid];
            if (!p) return null;
            return /*#__PURE__*/_jsxDEV("div", {
              style: {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: [liveData[pid] != null ? typeof liveData[pid] === 'number' ? liveData[pid].toFixed(pid === '0C' || pid === '0D' ? 0 : 1) : liveData[pid] : '—', " ", /*#__PURE__*/_jsxDEV("span", {
                  style: {
                    fontSize: 10,
                    color: '#64748b'
                  },
        ...
        }, void 0, false), monitoring && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
            ...
            children: [/*#__PURE__*/_jsxDEV("span", {
              ...
              children: ["📈 ", PIDS[graphPid]?.h || graphPid]
              ...
              children: PRESETS[preset].p.map(p => /*#__PURE__*/_jsxDEV("option", {
                value: p,
                children: PIDS[p]?.h || p
              }, p, false))
            }, void 0, false)]
          }, void 0, true), /*#__PURE__*/_jsxDEV(SimpleChart, {
            data: graphData,
            dataKey: "v",
            color: "#f59e0b"
          }, void 0, false)]
        }, void 0, true)]
      }, void 0, true), tab === 'dtc' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
            gap: 6,
          ...
          children: /*#__PURE__*/_jsxDEV("button", {
            ...
            children: loading ? '⏳...' : t('readDtc')
          }, void 0, false)
        }, void 0, false), vehicleInfo.milOn !== undefined && /*#__PURE__*/_jsxDEV("div", {
          style: {
            ...s.card,
          ...
          children: /*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("span", {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: vehicleInfo.milOn ? t('milOn') : t('milOff')
              }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
                style: {
                  fontSize: 11,
                  color: '#94a3b8'
                },
                children: [t('faults'), ": ", vehicleInfo.dtcN || 0]
              }, void 0, true)]
            }, void 0, true)]
          }, void 0, true)
        }, void 0, false), dtcList.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 13,
              fontWeight: 600,
            ...
            children: [t('confirmed'), " (", dtcList.length, ")"]
          }, void 0, true), dtcList.map((d, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              ...s.card,
              borderColor: '#7f1d1d'
            },
        ...
        }, void 0, true), dtcPending.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 13,
              fontWeight: 600,
            ...
            children: [t('pending'), " (", dtcPending.length, ")"]
          }, void 0, true), dtcPending.map((d, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              ...s.card,
              borderColor: '#78350f'
            },
        ...
        }, void 0, true), dtcList.length === 0 && dtcPending.length === 0 && vehicleInfo.milOn !== undefined && /*#__PURE__*/_jsxDEV("div", {
          style: {
            textAlign: 'center',
            padding: 24,
            color: '#34d399'
        ...
        }, void 0, true), (dtcList.length > 0 || dtcPending.length > 0) && /*#__PURE__*/_jsxDEV("button", {
          style: {
            ...s.btn('#ef4444'),
            marginTop: 10
          },
          ...
          onClick: saveScan,
          children: ["💾 ", t('history'), " — ", isRTL ? 'שמור סריקה' : 'Save scan']
        }, void 0, true), scanHist.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 12,
            ...
            children: [t('history'), " (", scanHist.length, ")"]
          }, void 0, true), scanHist.slice(0, 5).map((h, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 10,
              padding: '4px 0',
            ...
            children: [/*#__PURE__*/_jsxDEV("span", {
              ...
              children: h.dtcCount > 0 ? h.dtcs.join(', ') : '✅ Clean'
            }, void 0, false)]
          }, i, true))]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: t('readyDesc')
          }, void 0, false), readyData && /*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
              flexWrap: 'wrap',
              gap: 5
            },
            children: readyData.mons.map((m, i) => {
              if (!m.s) return null;
              ...
              return /*#__PURE__*/_jsxDEV("div", {
                ...
                children: /*#__PURE__*/_jsxDEV("div", {
                  ...
                  children: [m.c ? '✅' : '❌', " ", names[i] || 'Monitor ' + i]
                }, void 0, true)
              }, i, false);
            })
          }, void 0, false)]
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: t('freezeD')
          }, void 0, false), freezeData && /*#__PURE__*/_jsxDEV("div", {
            children: [freezeData.trigger && /*#__PURE__*/_jsxDEV("div", {
              style: {
                padding: 6,
                background: '#450a0a',
                borderRadius: 6,
              ...
              children: [/*#__PURE__*/_jsxDEV("span", {
                ...
                children: freezeData.trigger.code
              }, void 0, false), " ", /*#__PURE__*/_jsxDEV("span", {
                style: {
                  fontSize: 10,
                  color: '#fca5a5'
                },
                children: freezeData.trigger.desc
              }, void 0, false)]
            }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
              style: {
                display: 'flex',
              ...
              children: Object.entries(freezeData).filter(([k]) => k !== 'trigger').map(([pid, d]) => /*#__PURE__*/_jsxDEV("div", {
                style: {
                  background: '#0f172a',
                  borderRadius: 6,
                  padding: '5px 8px',
                ...
                children: [/*#__PURE__*/_jsxDEV("div", {
                  ...
                  children: [d.v, " ", /*#__PURE__*/_jsxDEV("span", {
                    style: {
                      fontSize: 9,
                      color: '#64748b'
                    },
      ...
      }, void 0, true), tab === 'scan' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
            gap: 6,
          ...
          children: [/*#__PURE__*/_jsxDEV("button", {
            ...
            children: ecuScanning ? '⏳...' : t('scanAll')
          }, void 0, false), ecuList.filter(e => e.ok).length > 0 && /*#__PURE__*/_jsxDEV("button", {
            style: {
              ...s.btn('#3b82f6'),
              flex: 1
            },
        ...
        }, void 0, true), ecuProg && /*#__PURE__*/_jsxDEV("div", {
          style: {
            ...s.card,
            background: '#172554',
            borderColor: '#1e40af'
        ...
        }, void 0, false), kmRpt.length > 1 && /*#__PURE__*/_jsxDEV("div", {
          style: {
            ...s.card,
            background: '#1c1917',
            borderColor: '#78350f'
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: t('kmComp')
          }, void 0, false), kmRpt.map((r, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
              justifyContent: 'space-between',
              padding: '4px 0',
            ...
            return /*#__PURE__*/_jsxDEV("div", {
              ...
              children: [/*#__PURE__*/_jsxDEV("span", {
                ...
                children: [ok ? t('kmOk') : t('kmBad'), " — ", diff.toLocaleString(), " km"]
              }, void 0, true), !ok && /*#__PURE__*/_jsxDEV("div", {
                style: {
                  fontSize: 10,
                  color: '#fca5a5',
                  marginTop: 2
        ...
        }, void 0, true), ecuList.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          style: {
            marginTop: 10
          },
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [ecuList.filter(e => e.ok).length, " active / ", ecuList.length, " scanned"]
          }, void 0, true), ecuList.map((ecu, i) => {
            ...
            return /*#__PURE__*/_jsxDEV("div", {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: [/*#__PURE__*/_jsxDEV("div", {
                  ...
                  children: [/*#__PURE__*/_jsxDEV("span", {
                    ...
                    children: [/*#__PURE__*/_jsxDEV("div", {
                      ...
                      children: isRTL ? ecu.h || ecu.n : ecu.n
                    }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
                      style: {
                        fontSize: 9,
                        color: '#64748b',
                  ...
                  children: ecu.ok ? t('active') : t('inactive')
                }, void 0, false)]
              }, void 0, true), isSel && det && /*#__PURE__*/_jsxDEV("div", {
                style: {
                  marginTop: 10,
                  paddingTop: 10,
                ...
                }), det.dtcs && det.dtcs.length > 0 && /*#__PURE__*/_jsxDEV("div", {
                  style: {
                    marginTop: 6
                  },
                  children: [/*#__PURE__*/_jsxDEV("div", {
                    ...
                    children: [t('faults'), " (", det.dtcs.length, ")"]
                  }, void 0, true), det.dtcs.map((d, j) => /*#__PURE__*/_jsxDEV("div", {
                    style: {
                      fontSize: 10,
                      padding: '3px 6px',
                      background: '#450a0a',
                ...
                }, void 0, true), det.dtcs && det.dtcs.length === 0 && /*#__PURE__*/_jsxDEV("div", {
                  style: {
                    fontSize: 10,
                    color: '#34d399',
                    marginTop: 4
        ...
        }, void 0, true), ecuList.length === 0 && !ecuScanning && /*#__PURE__*/_jsxDEV("div", {
          style: {
            textAlign: 'center',
            padding: 30,
            color: '#64748b'
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: isRTL ? 'לחץ סרוק לגילוי כל המחשבים' : 'Press scan to discover all ECUs'
          }, void 0, false)]
        }, void 0, true)]
      }, void 0, true), tab === 'vehicle' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("button", {
          style: s.btn('#3b82f6', !isOn || loading),
          onClick: readVeh,
          disabled: !isOn || loading,
          children: loading ? '⏳...' : t('readVeh')
        }, void 0, false), Object.keys(vehicleInfo).length > 0 && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 14,
            ...
            children: t('vehInfo')
          }, void 0, false), [['VIN', vehicleInfo.vin], ['Protocol', vehicleInfo.proto], ['OBD', vehicleInfo.obdStd], ['Battery', vehicleInfo.batt ? vehicleInfo.batt + ' V' : null], ['MIL', vehicleInfo.milOn != null ? vehicleInfo.milOn ? 'ON 🔴' : 'OFF 🟢' : null]].map(([l, v], i) => v ? /*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
              justifyContent: 'space-between',
              padding: '5px 0',
        ...
        }, void 0, true), supPids.length > 0 && /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 12,
            ...
            children: [t('supPids'), " (", supPids.length, ")"]
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            style: {
              display: 'flex',
              flexWrap: 'wrap',
            ...
            children: supPids.map(pid => /*#__PURE__*/_jsxDEV("span", {
              style: {
                fontSize: 9,
                fontFamily: 'monospace',
              ...
              children: [pid, PIDS[pid] ? ' ' + PIDS[pid].h : '']
            }, pid, true))
          }, void 0, false)]
        }, void 0, true)]
      }, void 0, true), tab === 'term' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            background: '#0f172a',
            borderRadius: 8,
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: "───────────────"
          }, void 0, false), termHist.map((h, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              color: h.t === 'cmd' ? '#f59e0b' : '#e2e8f0',
              marginBottom: 1
            },
            children: [h.t === 'cmd' ? '> ' : ' ', h.v]
          }, i, true))]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: {
            display: 'flex',
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [['ATZ', 'Reset'], ['ATI', 'Version'], ['ATRV', 'Voltage'], ['ATDP', 'Protocol'], ['01 0C', 'RPM'], ['01 0D', 'Speed'], ['01 05', 'Temp'], ['01 11', 'Throttle'], ['03', 'Read DTC'], ['07', 'Pending'], ['04', 'Clear DTC'], ['09 02', 'VIN']].map(([c, l]) => /*#__PURE__*/_jsxDEV("button", {
              style: {
                ...s.btnS('#1e293b'),
                border: '1px solid #334155',
                color: '#94a3b8',
      ...
      }, void 0, true), tab === 'tools' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            fontSize: 15,
            fontWeight: 600,
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: ["I (", isRTL ? 'זרם' : 'Current', ") A"]
              }, void 0, true), /*#__PURE__*/_jsxDEV("input", {
                style: s.inp,
                value: ohmI,
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: ["R (", isRTL ? 'התנגדות' : 'Resistance', ") Ω"]
              }, void 0, true), /*#__PURE__*/_jsxDEV("input", {
                style: s.inp,
                value: ohmR,
          ...
          }, void 0, true), ohmV && ohmI && ohmR && /*#__PURE__*/_jsxDEV("div", {
            style: {
              marginTop: 6,
              fontSize: 12,
              color: '#94a3b8',
            ...
            children: ["P = ", (parseFloat(ohmV) * parseFloat(ohmI)).toFixed(2), " W (", isRTL ? 'הספק' : 'Power', ")"]
          }, void 0, true)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: isRTL ? '💡 בדיקה: מתח בין פין 16 ל-4/5 = 12V. CAN: ~2.5V על 6 ו-14' : '💡 Test: Pin 16 to 4/5 = 12V. CAN: ~2.5V on pins 6 & 14'
          }, void 0, false)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: ["🔋 ", isRTL ? 'טבלת מצבר' : 'Battery reference']
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            style: {
              fontSize: 10
            },
            children: [[['12.6V+', '100%', '#22c55e'], ['12.4V', '75%', '#22c55e'], ['12.2V', '50%', '#f59e0b'], ['12.0V', '25%', '#f59e0b'], ['11.8V', '0%', '#ef4444'], ['<11.5V', isRTL ? 'מת' : 'Dead', '#ef4444']].map((r, i) => /*#__PURE__*/_jsxDEV("div", {
              style: {
                display: 'flex',
                justifyContent: 'space-between',
                padding: '3px 0',
              ...
              children: isRTL ? 'אלטרנטור תקין: 13.5-14.5V. Cranking: מעל 9.6V' : 'Alternator: 13.5-14.5V. Cranking: above 9.6V'
            }, void 0, false)]
          }, void 0, true)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: s.card,
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: ["🔌 ", isRTL ? 'צבעי חיווט לפי יצרן' : 'Wire colors by manufacturer']
          }, void 0, true), [{
          ...
          }].map((mfr, i) => /*#__PURE__*/_jsxDEV("div", {
            style: {
              marginBottom: 10
            },
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: mfr.w.map((w, j) => /*#__PURE__*/_jsxDEV("div", {
                style: {
                  display: 'flex',
                  alignItems: 'center',
                  gap: 4,
      ...
      }, void 0, true), tab === 'guide' && /*#__PURE__*/_jsxDEV("div", {
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            fontSize: 16,
            fontWeight: 600,
          ...
          children: ["📖 ", isRTL ? 'מדריך למשתמש' : 'User Guide']
        }, void 0, true), [{
